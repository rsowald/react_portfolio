        ...
        <Container id="about" style={{ backgroundColor: "whitesmoke" }}>
            ...
            <Row>
                ...
                <Col size="sm-6">
                    ...
                    <p> In June, I completed a 24 week coding boot camp through the University of Washington. I am now a full MERN
                        stack developer, though I have much more development experience on the front end. I continue to learn and practice
                        on my own as I search for a full time position. To date, I have learned these major topics:
                    </p>
                    <ul>
                        <li>HTML</li>
                        <li>CSS</li>
                        ...
                        <li>Agile Workplace Methodologies</li>
                        <li>Node.js</li>
                        <li>Express</li>
                        <li>MySQL</li>
                        <li>Sequelize</li>
